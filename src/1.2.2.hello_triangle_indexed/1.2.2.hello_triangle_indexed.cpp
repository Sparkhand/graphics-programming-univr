/******************************************************************************
 * File:        1.2.2.hello_triangle_indexed.cpp
 * Author:      Davide Tarpini (https://github.com/Sparkhand)
 * Description: This example demonstrates how to draw a triangle using indexed
 *              drawing.
 *****************************************************************************/
...
const struct WINDOW_PROPS
{
    ...
    // Window title
    const char* TITLE = "LearnOpenGL - 1.2.2 - Hello Triangle Indexed";
    // Clear color
