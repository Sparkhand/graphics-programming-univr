/******************************************************************************
 * File:        1.4.2.textures_combined.cpp
 * Author:      Davide Tarpini (https://github.com/Sparkhand)
 * Description: This is an example of how to load two textures and combine them
...
const struct WINDOW_PROPS
{
    ...
    // Window title
    const char* TITLE = "LearnOpenGL - 1.4.2 - Textures Combined";
    // Clear color
...
int main()
{
    ...
    Shader ourShader("1.4.2.textures_combined.vs", "1.4.2.textures_combined.fs");
